...
<main>
                        ...
                        echo '
                                    <div class="box">
                                        <a href="thucdon.php?id_category=' . $item['id'] . '">
                                            <p>' . $item['name'] . '</p>
                                            <div class="bg"></div>
                                            <img src="images/bg/tbdt.jpg" alt="">
                                        </a>
                                    </div>
                                    ';
                    }
    ...
    <div class="title">
        <h1>Đồ công nghệ ><span class="Black">iPhone</span></h1>
    </div>
    <div class="product-restaurants">
        <div class="row">
            ...
            try {
                ...
                $limit = 4; // Số sản phẩm hiển thị trên mỗi trang
                $start = ($page - 1) * $limit;
                //id_category = 1 (iPhone)
                // Sửa đổi câu truy vấn để chỉ lấy các sản phẩm thuộc danh mục có id là 1 (iPhone)
                $sql = "SELECT * FROM product WHERE id_category = 1 LIMIT $start, $limit";
                $productList = executeResult($sql);
            ...
            <section class="restaurants">
                <div class="title">
                    <h1>Đồ công nghệ ><span class="Black">Laptop</span></h1>
                </div>
                <div class="product-restaurants">
                    <div class="row">
                        <?php
                        try {
                            ...
                            $limit = 4; //hiển thị sản phẩm
                            $start = ($page - 1) * $limit;
                            //id_category = 2 là laptop
                            $sql = "SELECT * FROM product WHERE id_category = 2 LIMIT $start, $limit";
                            executeResult($sql);
