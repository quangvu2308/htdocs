...
<main>
    <div class="container">
        ...
        <section class="search-quan">
                ...
                <form action="loaisp.php" method="GET">
        ...
        <section class="main">
            ...
            switch ($page) {
                //list menu danh sách thể loại sản phẩm
                case "thucdon":
                    require('menu-con/iphone.php');
                    require('menu-con/laptop.php');
                    require('menu-con/phukien.php');
                    require('menu-con/tablet.php');
                    break;
                default:
                    break;
            }
