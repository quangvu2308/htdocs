            ...
            <div class="container">
                ...
                <nav>
                    <ul>
                        ...
                        <li class="nav-cha">
                            <a href="../loaisp.php?page=loaisp">Sản Phẩm</a>
                            <ul class="nav-con">
                                <?php
                                $sql = "SELECT * FROM category";
                                $result = executeResult($sql);
                                foreach ($result as $item) {
                                    echo '<li><a href="../loaisp.php?id_category=' . $item['id'] . '">' . $item['name'] . '</a></li>';
                                }
                                ?>
